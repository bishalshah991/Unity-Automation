...
public class TestBase extends BasePage {
    ...
    @BeforeTest
    public void Setup(ITestContext context, @Optional("chrome") String browser, String url) throws IOException, ParseException {
    ...
    public void LaunchBrowser(String browser,String Url) throws IOException, ParseException {
        ...
        driver.get(Url);
        WaitForPresenceOfElement(new LoginPage().TextLogin,10);
        WaitForPresenceOfElement(new LoginPage().LoginButton,10);
        String  version = GetText(new LoginPage().Version);
        extentReports.setSystemInfo("System version",version);
    }
